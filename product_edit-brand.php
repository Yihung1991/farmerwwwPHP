...
if (empty($sid)) {
  header('Location: product_list-brand'); // 轉向到列表頁
  exit;
}
...
<div class="container">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">修改品牌</li>
    </ol>
  </nav>
  <section class="mt-2">
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page"><a href="#">產品列表</a></li>
          <li class="breadcrumb-item active" aria-current="page">品牌管理</li>
        </ol>
      </nav>
