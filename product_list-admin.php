    ...
    <div class="container">
      ...
      <div class="product_content shadow d-flex flex-wrap ">
        <div class="dropdown mb-3 col-4 pe-2">
          ...
          <input type="text" class="form-control" id="product_name" name="product_name" required placeholder="請輸入產品名稱或編號">
        ...
        <div class="dropdown mb-3 col-4 pe-2">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item text-center" href="product_list-admin.php">所有會員</a></li>
              <li><a class="dropdown-item text-center" href="product_list-admin.php?state_sid=1"><?= $state[0]['product_state'] ?></a></li>
              <li><a class="dropdown-item text-center" href="product_list-admin.php?state_sid=2"><?= $state[1]['product_state'] ?></a></li>
              <li><a class="dropdown-item text-center" href="product_list-admin.php?state_sid=3"><?= $state[2]['product_state'] ?></a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="mb-3 col-4 pe-2 visually-hidden">
          ...
          <input type="date" class="form-control" id="product_publish_date" name="product_publish_date">
        ...
        <div>
          ...
          <button type="button" class="btn btn-primary ms-2">搜尋</button>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class=" ">
    ...
    <div class="mt-2">
      <div class="container">
        <div class="product_title shadow">
          產品列表
          <button class="btn btn-secondary float-end me-3 my-0 py-0" onclick="location.href ='product_list-category.php'">分類管理</button>
          <button class="btn btn-secondary float-end me-3 my-0 py-0" onclick="location.href ='product_list-brand.php'">品牌管理</button>
          <button class="btn btn-success float-end me-3 my-0 py-0" onclick="location.href ='product_add.php'">新增產品</button>
        </div>
      ...
      <tbody>
        ...
        <?php foreach ($rows as $key => $r) : ?>
          ...
          <td><?= $r['product_publish_date'] ?></td>
          <td><?= $r['product_end_date'] ?></td>
          ...
          <td>
            ...
            &nbsp;
            <a id="<?= $r['sid'] ?>" value="<?= $r['product_name'] ?> " href="javascript: delete_it(<?= $r['sid'] ?>)">
